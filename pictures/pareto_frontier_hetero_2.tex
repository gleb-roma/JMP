...
\def\myshift#1{\raisebox{1ex}}
	...
	\coordinate (A) at (6,3);
        ...
        \draw[line width=2.5,postaction={decorate,decoration={text along path,text align=center,text={|\myshift|Implementability fr.}}}] plot [smooth,tension=1.3] coordinates {(1.8,5.6) (4.3,4.8) (6,3)  };
